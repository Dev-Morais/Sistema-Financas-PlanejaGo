    ...
    <div class="relative flex h-16 items-center justify-between">
      ...
      <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
        ...
        <?php if(auth()->guard()->guest()): ?>
          <?php if(Route::is('user.create') || Route::is('login.index')): ?>
            <a href="<?php echo e(route('home')); ?>" class="bg-white p-2 border rounded-sm">Cancelar</a>
          <?php else: ?>
          <div class="flex space-x-2">
            
            <a href="<?php echo e(route('user.create')); ?>" class="bg-white p-2 border rounded-sm">Registrar-se</a>
            
            <a href="<?php echo e(route('login.index')); ?>" class="bg-purple-300 p-2 border rounded-sm">Login</a>
          </div>
          <?php endif; ?>
        <?php endif; ?>
...
</nav><?php /**PATH C:\Projetos\Sistema-Financas-PlanejaGo\sistema-planejago\resources\views/shared/_navbar.blade.php ENDPATH**/ ?>